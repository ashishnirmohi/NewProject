...
import org.testng.Assert;
	...
	public class InviteBuyerAdminNormalShare {
	...
	public void launchbrowser() throws IOException, Exception {
		...
		InviteBuyerAdminNormalShare.captureScreenShot(driver);
	}
	...
	public void community_StandardInvite() throws InterruptedException, IOException { 
	    ...
	    invitelink.click(); Thread.sleep(4000); InviteBuyerAdminNormalShare.captureScreenShot(driver); 
	    ...
	    invite.click(); Thread.sleep(6000); InviteBuyerAdminNormalShare.captureScreenShot(driver); 
	    ...
	    WebElement InviteLink = driver.findElement(By.xpath("//a[contains(@class,'invite-icon')]")); Thread.sleep(5000);
	    Assert.assertTrue(InviteLink.isDisplayed()); Thread.sleep(4000);
	    InviteLink.click(); Thread.sleep(5000);	 InviteBuyerAdminNormalShare.captureScreenShot(driver);    
	    ...
	    invitebuTTon.click(); Thread.sleep(5000); InviteBuyerAdminNormalShare.captureScreenShot(driver);
	    ...
	    email.clear(); email.sendKeys("suri4949@yopmail.com");
	    ...
	    email.clear(); email.sendKeys("QualityA3Nirmohi78@yopmail.com");
	...
	public void invite_URL() throws Exception {
		...
		InviteBuyerAdminNormalShare.captureScreenShot(driver); Thread.sleep(5000);
		...
		createURL.click(); Thread.sleep(5000); InviteBuyerAdminNormalShare.captureScreenShot(driver); Thread.sleep(5000);
