...
import org.testng.Assert;
	...
	public class InviteSellerAdminNormalShare {
	...
	public void launchbrowser() throws IOException, Exception {
		...
		InviteSellerAdminNormalShare.captureScreenShot(driver);
	}
	@Test (priority = 0)
	public void homepageSellerAdminlogin() throws InterruptedException, Exception {
		...
		driver.findElement(By.id("email")).sendKeys("ashishds01@mailinator.com"); Thread.sleep(5000);
	...
	public void Community_InviteFromSellerAdmin() throws InterruptedException, IOException { 
	    ...
	    invitelink.click(); Thread.sleep(4000); InviteSellerAdminNormalShare.captureScreenShot(driver); 
	    ...
	    invite.click(); Thread.sleep(6000); InviteSellerAdminNormalShare.captureScreenShot(driver); 
	    ...
	    WebElement InviteLink = driver.findElement(By.xpath("//a[contains(@class,'invite-icon')]"));
	    Assert.assertTrue(InviteLink.isDisplayed()); Thread.sleep(4000);
	    InviteLink.click(); Thread.sleep(5000);	 InviteSellerAdminNormalShare.captureScreenShot(driver);    
	    ...
	    invitebuTTon.click(); Thread.sleep(5000); InviteSellerAdminNormalShare.captureScreenShot(driver);
	...
	public void invite_URL() throws Exception {
		...
		InviteSellerAdminNormalShare.captureScreenShot(driver); Thread.sleep(5000);
		...
		createURL.click(); Thread.sleep(5000); InviteSellerAdminNormalShare.captureScreenShot(driver); Thread.sleep(5000);
