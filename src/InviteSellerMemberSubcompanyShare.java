	...
	public class InviteSellerMemberSubcompanyShare {
	...
	public void launchbrowser() throws IOException, Exception {
		...
		InviteSellerMemberSubcompanyShare.captureScreenShot(driver);
	}
	...
	public void homepageSellerMemberSubcompanyShareLogin() throws InterruptedException, Exception {
		...
		driver.findElement(By.id("email")).sendKeys("ashishqao23@yopmail.com"); Thread.sleep(5000);
	...
	public void community_InviteSellerMemberSubcompanyShare() throws InterruptedException, IOException { 
	    ...
	    invitelink.click(); Thread.sleep(4000); InviteSellerMemberSubcompanyShare.captureScreenShot(driver); 
	    ...
	    invite.click(); Thread.sleep(6000); InviteSellerMemberSubcompanyShare.captureScreenShot(driver); 
	    ...
	    WebElement InviteLink = driver.findElement(By.xpath("//a[contains(@class,'invite-icon')]"));
	    Assert.assertTrue(InviteLink.isDisplayed()); Thread.sleep(4000);
	    InviteLink.click(); Thread.sleep(5000);	 InviteSellerMemberSubcompanyShare.captureScreenShot(driver);    
	    ...
	    invitebuTTon.click(); Thread.sleep(5000); InviteSellerMemberSubcompanyShare.captureScreenShot(driver);
	    ...
	    WebElement invitebutToN = driver.findElement(By.xpath("//button[contains(@class,'btn-invite')]"));
	    Assert.assertTrue(message.isDisplayed()); Thread.sleep(4000); message.getText();
	    invitebutToN.click(); Thread.sleep(5000); InviteSellerMemberSubcompanyShare.captureScreenShot(driver);
	    ...
	    blueMessage.getText(); blueMessage.click();
