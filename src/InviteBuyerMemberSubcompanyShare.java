...
import org.testng.Assert;
	...
	public class InviteBuyerMemberSubcompanyShare {
	...
	public void launchbrowser() throws IOException, Exception {
		...
		InviteBuyerMemberSubcompanyShare.captureScreenShot(driver);
	}
	@Test (priority = 0)
	public void homepageBuyerMemberSubcompanyShareLogin() throws InterruptedException, Exception {
		...
		driver.findElement(By.id("email")).sendKeys("qex9011@yopmail.com"); Thread.sleep(5000);
	...
	public void community_InviteBuyerMemberSubcompanyShare() throws InterruptedException, IOException { 
	    ...
	    invitelink.click(); Thread.sleep(4000); InviteBuyerMemberSubcompanyShare.captureScreenShot(driver); 
	    ...
	    invite.click(); Thread.sleep(6000); InviteBuyerMemberSubcompanyShare.captureScreenShot(driver); 
	    ...
	    WebElement InviteLink = driver.findElement(By.xpath("//a[contains(@class,'invite-icon')]"));
	    Assert.assertTrue(InviteLink.isDisplayed()); Thread.sleep(4000);
	    InviteLink.click(); Thread.sleep(5000);	 InviteBuyerMemberSubcompanyShare.captureScreenShot(driver);    
	    ...
	    invitebuTTon.click(); Thread.sleep(5000); InviteBuyerMemberSubcompanyShare.captureScreenShot(driver);
	...
	public void invite_URL() throws Exception {
		...
		InviteBuyerMemberSubcompanyShare.captureScreenShot(driver); Thread.sleep(5000);
		...
		createURL.click(); Thread.sleep(5000); InviteBuyerMemberSubcompanyShare.captureScreenShot(driver); Thread.sleep(5000);
