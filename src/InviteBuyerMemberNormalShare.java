...
import org.testng.Assert;
	...
	public class InviteBuyerMemberNormalShare {
	...
	public void launchbrowser() throws IOException, Exception {
		...
		InviteBuyerMemberNormalShare.captureScreenShot(driver);
	}
	...
	public void homepageBuyerMemberLogin() throws InterruptedException, Exception {
		...
		driver.findElement(By.id("email")).sendKeys("ashishb1@mailinator.com"); Thread.sleep(5000);
	...
	public void community_InviteFromBuyerMemberNormalShare() throws InterruptedException, IOException { 
	    ...
	    invitelink.click(); Thread.sleep(4000); InviteBuyerMemberNormalShare.captureScreenShot(driver); 
	    ...
	    invite.click(); Thread.sleep(6000); InviteBuyerMemberNormalShare.captureScreenShot(driver); 
	    ...
	    WebElement InviteLink = driver.findElement(By.xpath("//a[contains(@class,'invite-icon')]"));
	    Assert.assertTrue(InviteLink.isDisplayed()); Thread.sleep(4000);
	    InviteLink.click(); Thread.sleep(5000);	 InviteBuyerMemberNormalShare.captureScreenShot(driver);    
	    ...
	    invitebuTTon.click(); Thread.sleep(5000); InviteBuyerMemberNormalShare.captureScreenShot(driver);
	...
	public void invite_URL() throws Exception {
		...
		InviteBuyerMemberNormalShare.captureScreenShot(driver); Thread.sleep(5000);
		...
		createURL.click(); Thread.sleep(5000); InviteBuyerMemberNormalShare.captureScreenShot(driver); Thread.sleep(5000);
