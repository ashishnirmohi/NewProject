...
import org.testng.Assert;
	...
	public class InviteBuyerAdminSubcompanyShare {
	...
	public void launchbrowser() throws IOException, Exception {
		...
		InviteBuyerAdminSubcompanyShare.captureScreenShot(driver);
	}
	@Test (priority = 0)
	public void homepageBuyerAdminSubcompanyCS() throws InterruptedException, Exception {
		...
		driver.findElement(By.id("email")).sendKeys("qex9007@yopmail.com"); Thread.sleep(5000);
	...
	public void community_InviteFromBuyerAdminSubcompanyShare() throws InterruptedException, IOException { 
	    ...
	    invitelink.click(); Thread.sleep(4000); InviteBuyerAdminSubcompanyShare.captureScreenShot(driver); 
	    ...
	    invite.click(); Thread.sleep(6000); InviteBuyerAdminSubcompanyShare.captureScreenShot(driver); 
	    ...
	    WebElement InviteLink = driver.findElement(By.xpath("//a[contains(@class,'invite-icon')]"));
	    Assert.assertTrue(InviteLink.isDisplayed()); Thread.sleep(4000);
	    InviteLink.click(); Thread.sleep(5000);	 InviteBuyerAdminSubcompanyShare.captureScreenShot(driver);    
	    ...
	    invitebuTTon.click(); Thread.sleep(5000); InviteBuyerAdminSubcompanyShare.captureScreenShot(driver);
	    ...
	    email.clear();
	    email.sendKeys("qex9008@yopmail.com");
	    ...
	    blueMessage.click();
	    driver.findElement(By.xpath("/html/body/section/div[2]/div/div/div/div[2]/div/div[2]/div[1]/button")).click(); Thread.sleep(5000);
	    InviteBuyerAdminSubcompanyShare.captureScreenShot(driver); 
	...
	@Test (priority=2)
	public void invite_URL() throws InterruptedException, Exception {
		...
		InviteBuyerAdminSubcompanyShare.captureScreenShot(driver); Thread.sleep(5000);
		...
		createURL.click(); Thread.sleep(5000); InviteBuyerAdminSubcompanyShare.captureScreenShot(driver); Thread.sleep(5000);
