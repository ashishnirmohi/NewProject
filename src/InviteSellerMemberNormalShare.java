...
import org.testng.Assert;
	...
	public class InviteSellerMemberNormalShare {
	...
	public void launchbrowser() throws IOException, Exception {
		...
		InviteSellerMemberNormalShare.captureScreenShot(driver);
	}
	@Test (priority = 0)
	public void homepageLoginSellerMember() throws InterruptedException, Exception {
		...
		driver.findElement(By.id("email")).sendKeys("ashishbcom11@mailinator.com"); Thread.sleep(5000);
	...
	public void community_InviteFromSellerMember() throws InterruptedException, IOException { 
	    ...
	    invite.click(); Thread.sleep(6000); InviteSellerMemberNormalShare.captureScreenShot(driver); 
	    ...
	    WebElement InviteLink = driver.findElement(By.xpath("//a[contains(@class,'invite-icon')]"));
	    Assert.assertTrue(InviteLink.isDisplayed()); Thread.sleep(4000);
	    InviteLink.click(); Thread.sleep(5000);	 InviteSellerMemberNormalShare.captureScreenShot(driver);    
	    ...
	    invitebuTTon.click(); Thread.sleep(5000); InviteSellerMemberNormalShare.captureScreenShot(driver);
